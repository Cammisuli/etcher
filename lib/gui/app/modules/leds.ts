...
export const ledsMap: RGBLed[] = [
    [24, 23, 25],
    [14, 15, 18],
    [5, 26, 6],
    [17, 22, 27],
].map(gpioNumbers => new RGBLed(gpioNumbers as [number, number, number]));

// leds[0].setColor(0, 0, 0);
// leds[1].setColor(1, 1, 1);
// leds[2].setAnimation('blink-white');
// leds[3].setAnimation('breathe-white');
